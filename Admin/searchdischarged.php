...
<html>
<head>
<title>Search Discharged Patients</title>
...
function showHint(str) {
    if (str.length == 0) {
        ...
        xmlhttp.open("GET", "gethintdis.php?q="+str, true);
        xmlhttp.send();
    }
}
</script>
...
function showHintdate(str) {
    ...
    if (str.length == 0) {
        ...
        xmlhttp.open("GET", "gethintdatedis.php?q="+str, true);
        xmlhttp.send();
    }
}
</script>
...
<br>
<h1 class="w3-center">Search Discharged Patient</h1>
<br>
<br>	
...
<div class="row">
		   ...
		   <form class="needs-validation" novalidate method="post">
                   ...
                   <label for="ipno"><strong>Enter Date Of Discharge</strong></label>
