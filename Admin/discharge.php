...
<br>
<h1 class="w3-center">Discharge Form</h1>
<br>
<br>	
<div class="container-fluid">
        ...
        <div class="row">
	     ...
	     <form class="needs-validation" action="delete.php" novalidate method="post">
	  ...
	  <div class="row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="gender" class="form-control" id="gender" placeholder="Gender" value="<?php echo htmlentities($gender); ?>" required>
                <div class="invalid-feedback">
	      ...
	      <div class="col-md-4 mb-3">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="text" name="state" class="form-control" id="state" placeholder="State" value="<?php echo htmlentities($state); ?>" required>
                <div class="invalid-feedback">
		...
		<div class="mb-3">
              ...
              <input type="text" name="refdoc" class="form-control" id="refdoc" placeholder="Refered Doctor" value="<?php echo htmlentities($refdoc); ?>" required>
              <div class="invalid-feedback">
		...
		<div class="col-md-4 mb-3">
		   <label for="category">Category</label>
                <input type="text" name="category" class="form-control" id="category" placeholder="Category" value="<?php echo htmlentities($category); ?>"  required>
                <div class="invalid-feedback">
		...
		<div class="col-md-4 mb-3">
		   <label for="roomno">Room Number</label>
                <input type="text" name="roomno" class="form-control" id="roomno" placeholder="Room Number" value="<?php echo htmlentities($roomno); ?>" >
                <div class="invalid-feedback">
                  Room Number is required.
                </div>
		 </div>
		</div>
            <button class="btn btn-primary btn-lg btn-block" type="submit">Discharge Patient</button>
         </div>
      </div>
