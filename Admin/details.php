...
<br>
<h1 class="w3-center">View Patient Details</h1>
<br>
<br>	
<div class="container-fluid">
        ...
        <div class="row">
		   ...
		   <form class="needs-validation"  >
                   ...
                   <label for="ipno"><strong>IP Number</strong></label>
                   <input type="text" name="ipno" class="form-control" id="ipno" value="<?php echo htmlentities($ipno); ?>" placeholder="IP Number" disabled required>
               </div>
	     ...
	     <form class="needs-validation" action="save1.php"  method="post">
	  ...
	  <div class="row">
		...
		<div class="col-md-4 mb-3">
		   <label for="roomno">Room Number</label>
                <input type="text" name="roomno" class="form-control" id="roomno" placeholder="Room Number" value="<?php echo htmlentities($roomno); ?>" disabled required>
               
		 </div>
		</div>
	</form>
	<form action="search.php">
		<button class="btn btn-primary btn-lg btn-block" >Back To Search</button>
	</form>
